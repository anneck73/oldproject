...
/**
 * Class PayoutHomeMealsService is a helper service for commands in this bundle.
 */
class PayoutHomeMealsService
{
    /**
     * @var HomeMealService
     */
    ...
    public function __construct(HomeMealService $homeMealService, MealTicketService $mealTicketService, Logger $logger)
    {
    ...
    public function findHomeMealPayouts(): Collection
    {

...
/**
 * The Coupon Class enables mealmatch global marketplace coupons.
 *
 * @ORM\Entity()
 * @ORM\Table(name="coupon")
 * @UniqueEntity("code")
 */
class Coupon extends AbstractEntity implements CouponDataInterface
{
    /**
     * @var string
     * @ORM\Column(type="string", length=64)
     */
    protected $title = 'CouponDefaultTitle';

    /**
     * @var string
     * @ORM\Column(type="string", length=64)
     */
    protected $description = 'CouponDefaultDescription';

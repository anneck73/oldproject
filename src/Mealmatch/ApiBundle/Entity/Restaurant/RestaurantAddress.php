...
namespace Mealmatch\ApiBundle\Entity\Restaurant;
 ...
 */
class RestaurantAddress extends AbstractEntity implements GeoCodeable
{
    /*
     * TRAITS
     */
    ...
    public function setCoordinates(float $long, float $lat): self
    {

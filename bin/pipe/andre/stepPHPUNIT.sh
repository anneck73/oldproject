...
vendor/bin/phpunit -d memory_limit=1G -dxdebug.coverage_enable=1 -dxdebug.profiler_enable=0 -c phpunit.xml.pipeline --log-junit build/phpunit/phpunit.xml --testdox-html build/phpunit/phpunit.html --coverage-clover build/phpunit/clover.xml --coverage-html build/phpunit/coverage.html

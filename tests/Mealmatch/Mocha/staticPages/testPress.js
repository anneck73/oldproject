...
describe('Test press page', function () {

    it('Press page should be here', async () => {
        ...
        await page.waitForSelector('body > div.content > footer > div.primary-footer > div:nth-child(1) > div > div >' +
            ' div.col-md-5th-1.col-sm-4.col-md-offset-0 > div > ul > li:nth-child(3) > a');
